      ...
      <section className='mx-auto flex h-screen w-full'>
        ...
        <aside className={`${chats[currentChatId]?.messages.length > 0 ? 'flex' : 'hidden md:flex'} h-full w-64 shrink-0 flex-col border-r border-yellow-600/30 bg-gradient-to-b from-black to-slate-900 p-4`}>
          ...
          <div className='mb-8 flex items-center gap-2'>
            ...
            <h1 className='text-2xl font-bold tracking-tight text-white'>SyncSpace
</h1>
          </div>
            ...
            {chats[currentChatId]?.messages?.length === 0 ? (
              ...
              <div className='flex flex-col items-center justify-center h-full'>
                <div className='text-center max-w-2xl px-4'>
                  ...
                  <h2 className='text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-yellow-400 to-yellow-300 bg-clip-text text-transparent'>Welcome to SyncSpace
</h2>
