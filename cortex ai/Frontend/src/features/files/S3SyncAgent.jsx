  ...
  return (
    <div className="s3-sync-container">
      <div className="sync-header">
        <h3>☁️ Chat Storage Agent</h3>
        <span className={`sync-badge ${syncStatus}`}>
          {syncStatus === 'idle' && '⏸ Ready'}
          {syncStatus === 'syncing' && '🔄 Storing...'}
      ...
      <div className="sync-card">
        <div className="sync-info">
          <div className="info-row">
            ...
            {syncStatus === 'idle' && '✅ All chats saved'}
            {syncStatus === 'syncing' && '⏳ Storing...'}
            {syncStatus === 'success' && '✅ Storage complete'}
            </span>
          </div>
          <div className="info-row">
        ...
        <div className="progress-section">
          <div className="progress-label">
            <span>Storage Progress: {Math.floor(progress)}%</span>
          </div>
        ...
        <div className="sync-actions">
          ...
          >
            {syncStatus === 'syncing' ? '⏳ Storing...' : '🔄 Store Chat'}
          </button>
