        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white relative overflow-hidden">
            ...
            <header className="relative z-10 flex justify-between items-center p-6">
                <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xl font-bold">Cortex AI
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl md:text-2xl text-slate-200 mb-8 drop-shadow-lg max-w-2xl mx-auto">
                  A chatbot experience built to answer questions, generate ideas, and help you get things done.
                </p>
                {!user && (
                  <Link 
                    to="/register" 
...
<section id="about" className="relative z-10 py-20 bg-black/70 border-t-2 border-yellow-600/30">
    <div className="max-w-4xl mx-auto text-center px-6">
        <h2 className="text-4xl font-bold mb-6 text-yellow-400">About Cortex AI
</h2>
        <p className="text-lg text-slate-300 mb-8">
            Cortex AI is an intelligent conversational assistant that helps you chat, explore knowledge, and generate responses with the power of modern AI.
        </p>
        <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-black/40 rounded-lg border border-yellow-600/30 hover:border-yellow-400/50 transition-colors">
                ...
                <h3 className="text-xl font-semibold mb-2 text-yellow-400">Secure Conversations</h3>
                <p className="text-slate-300">Encrypted sessions and JWT authentication keep your chat history private.</p>
            </div>
            
            {/* Feature 3: Response Speed */}
            <div className="p-6 bg-black/40 rounded-lg border border-yellow-600/30 hover:border-yellow-400/50 transition-colors">
                <div className="w-12 h-12 bg-yellow-500/20 rounded-lg flex items-center justify-center mx-auto mb-4">
                    <svg className="h-6 w-6 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="text-xl font-semibold mb-2 text-yellow-400">Instant Responses</h3>
                <p className="text-slate-300">Fast AI replies help you iterate on ideas and get answers in real time.</p>
            </div>
        </div>
    </div>
</section>
            ...
            <section id="info" className="relative z-10 py-20">
                <div className="max-w-4xl mx-auto text-center px-6">
                    <h2 className="text-4xl font-bold mb-6 text-yellow-400">Getting Started with Cortex AI</h2>
                    <p className="text-lg text-slate-300 mb-12">
                        Start chatting with your AI assistant in three easy steps.
                    </p>
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="text-center">
                            ...
                            <p className="text-slate-300">Register and start your AI-powered conversations.</p>
                        </div>
                        <div className="text-center">
                            <div className="w-16 h-16 bg-yellow-400/20 rounded-full flex items-center justify-center mx-auto mb-4">
                                <span className="text-2xl font-bold text-yellow-400">2</span>
                            </div>
                            <h3 className="text-xl font-semibold mb-2 text-yellow-400">Open Dashboard</h3>
                            <p className="text-slate-300">Send messages, review replies, and explore chat history.</p>
                        </div>
                        <div className="text-center">
                            <div className="w-16 h-16 bg-yellow-400/20 rounded-full flex items-center justify-center mx-auto mb-4">
                                <span className="text-2xl font-bold text-yellow-400">3</span>
                            </div>
                            <h3 className="text-xl font-semibold mb-2 text-yellow-400">Ask Anything</h3>
                            <p className="text-slate-300">Get instant AI responses and let Cortex help you think faster.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] items-center">
                  <div>
                    ...
                    <p className="mt-4 text-lg leading-8 text-slate-300">
                      Cortex AI
 is presented as a modern multi-agent platform where the frontend gateway, authentication service, AI orchestrator, and data persistence layer all work together like AWS services.
                    </p>
            ...
            <section id="plans" className="relative z-10 py-20 bg-black/70 border-t-2 border-yellow-600/30">
                <div className="max-w-6xl mx-auto text-center px-6">
                    <h2 className="text-4xl font-bold mb-6 text-yellow-400">Chat Plans</h2>
                    <p className="text-lg text-slate-300 mb-12">
                        Choose the right AI plan for your chat and productivity needs.
                    </p>
                    <div className="grid md:grid-cols-3 gap-8">
            ...
            <footer className="relative z-10 py-12 text-center border-t border-yellow-600/30 bg-black/70">
                <p className="text-slate-300">&copy; 2024 Cortex AI
